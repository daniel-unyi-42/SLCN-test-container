...
from model.largemlp import LargeMLP
import pandas as pd
...
class Slcn_algorithm(ClassificationAlgorithm):
    def __init__(self):
        ...
        if execute_in_docker:
            self.path_model = "/opt/algorithm/checkpoints/largeMLP2.pt"
            ...
            self.path_model = "./weights/largeMLP2.pt"
        ...
        self.model = LargeMLP(28, [28, 28, 28, 28], 3, device=self.device)
