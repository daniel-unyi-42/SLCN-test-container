...
RUN pip install --no-cache-dir torch-scatter -f https://data.pyg.org/whl/torch-1.11.0+cu115.html
RUN pip install --no-cache-dir torch-sparse -f https://data.pyg.org/whl/torch-1.11.0+cu115.html
RUN pip install --no-cache-dir torch-cluster -f https://data.pyg.org/whl/torch-1.11.0+cu115.html
RUN pip install --no-cache-dir torch-spline-conv -f https://data.pyg.org/whl/torch-1.11.0+cu115.html
